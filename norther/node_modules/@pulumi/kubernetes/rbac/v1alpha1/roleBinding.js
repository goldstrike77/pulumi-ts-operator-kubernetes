...
class RoleBinding extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:rbac.authorization.k8s.io/v1:RoleBinding" }, { type: "kubernetes:rbac.authorization.k8s.io/v1beta1:RoleBinding" }] };
    ...
    static get(name, id, opts) {
        return new RoleBinding(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
RoleBinding.__pulumiType = 'kubernetes:rbac.authorization.k8s.io/v1alpha1:RoleBinding';
