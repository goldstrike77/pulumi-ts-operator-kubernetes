...
class Role extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:rbac.authorization.k8s.io/v1:Role" }, { type: "kubernetes:rbac.authorization.k8s.io/v1alpha1:Role" }] };
...
exports.Role = Role;
/** @internal */
Role.__pulumiType = 'kubernetes:rbac.authorization.k8s.io/v1beta1:Role';
