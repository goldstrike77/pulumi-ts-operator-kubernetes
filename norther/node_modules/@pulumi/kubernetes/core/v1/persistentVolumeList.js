...
exports.PersistentVolumeList = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../../utilities");
/**
 * PersistentVolumeList is a list of PersistentVolume items.
 */
class PersistentVolumeList extends pulumi.CustomResource {
    /**
    ...
    constructor(name, args, opts) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "PersistentVolumeList";
        ...
        super(PersistentVolumeList.__pulumiType, name, resourceInputs, opts);
    }
    /**
    ...
    static get(name, id, opts) {
        return new PersistentVolumeList(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
PersistentVolumeList.__pulumiType = 'kubernetes:core/v1:PersistentVolumeList';
//# sourceMappingURL=persistentVolumeList.js.map