...
exports.NamespaceList = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../../utilities");
/**
 * NamespaceList is a list of Namespaces.
 */
class NamespaceList extends pulumi.CustomResource {
    /**
    ...
    constructor(name, args, opts) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "NamespaceList";
        ...
        super(NamespaceList.__pulumiType, name, resourceInputs, opts);
    }
    /**
    ...
    static get(name, id, opts) {
        return new NamespaceList(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
NamespaceList.__pulumiType = 'kubernetes:core/v1:NamespaceList';
//# sourceMappingURL=namespaceList.js.map