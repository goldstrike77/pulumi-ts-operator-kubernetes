...
exports.EndpointsList = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../../utilities");
/**
 * EndpointsList is a list of endpoints.
 */
class EndpointsList extends pulumi.CustomResource {
    /**
    ...
    constructor(name, args, opts) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "EndpointsList";
        ...
        super(EndpointsList.__pulumiType, name, resourceInputs, opts);
    }
    /**
    ...
    static get(name, id, opts) {
        return new EndpointsList(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
EndpointsList.__pulumiType = 'kubernetes:core/v1:EndpointsList';
