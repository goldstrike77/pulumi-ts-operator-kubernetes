...
class LimitRange extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "LimitRange";
        ...
        super(LimitRange.__pulumiType, name, resourceInputs, opts);
    }
    /**
    ...
    static get(name, id, opts) {
        return new LimitRange(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
LimitRange.__pulumiType = 'kubernetes:core/v1:LimitRange';
//# sourceMappingURL=limitRange.js.map