...
exports.ReplicationController = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../../utilities");
/**
 * ReplicationController represents the configuration of a replication controller.
 */
class ReplicationController extends pulumi.CustomResource {
    /**
    ...
    constructor(name, args, opts) {
        ...
        super(ReplicationController.__pulumiType, name, resourceInputs, opts);
    }
    /**
    ...
    static get(name, id, opts) {
        return new ReplicationController(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
ReplicationController.__pulumiType = 'kubernetes:core/v1:ReplicationController';
//# sourceMappingURL=replicationController.js.map