...
exports.PodTemplateList = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../../utilities");
/**
 * PodTemplateList is a list of PodTemplates.
 */
class PodTemplateList extends pulumi.CustomResource {
    /**
    ...
    constructor(name, args, opts) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "PodTemplateList";
        ...
        super(PodTemplateList.__pulumiType, name, resourceInputs, opts);
    }
    /**
    ...
    static get(name, id, opts) {
        return new PodTemplateList(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
PodTemplateList.__pulumiType = 'kubernetes:core/v1:PodTemplateList';
//# sourceMappingURL=podTemplateList.js.map