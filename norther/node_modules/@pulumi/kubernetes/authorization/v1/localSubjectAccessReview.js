...
exports.LocalSubjectAccessReview = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../../utilities");
/**
 * LocalSubjectAccessReview checks whether or not a user or group can perform an action in a given namespace. Having a namespace scoped resource makes it much easier to grant namespace scoped policy that includes permissions checking.
 */
class LocalSubjectAccessReview extends pulumi.CustomResource {
    /**
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:authorization.k8s.io/v1beta1:LocalSubjectAccessReview" }] };
    ...
    static get(name, id, opts) {
        return new LocalSubjectAccessReview(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
LocalSubjectAccessReview.__pulumiType = 'kubernetes:authorization.k8s.io/v1:LocalSubjectAccessReview';
//# sourceMappingURL=localSubjectAccessReview.js.map