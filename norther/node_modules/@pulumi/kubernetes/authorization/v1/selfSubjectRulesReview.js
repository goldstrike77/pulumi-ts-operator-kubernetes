...
class SelfSubjectRulesReview extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:authorization.k8s.io/v1beta1:SelfSubjectRulesReview" }] };
...
/** @internal */
SelfSubjectRulesReview.__pulumiType = 'kubernetes:authorization.k8s.io/v1:SelfSubjectRulesReview';
