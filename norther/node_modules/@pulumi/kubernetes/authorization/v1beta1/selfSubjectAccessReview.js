...
exports.SelfSubjectAccessReview = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../../utilities");
/**
 * SelfSubjectAccessReview checks whether or the current user can perform an action.  Not filling in a spec.namespace means "in all namespaces".  Self is a special case, because users should always be able to check whether they can perform an action
 */
class SelfSubjectAccessReview extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new SelfSubjectAccessReview(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
SelfSubjectAccessReview.__pulumiType = 'kubernetes:authorization.k8s.io/v1beta1:SelfSubjectAccessReview';
