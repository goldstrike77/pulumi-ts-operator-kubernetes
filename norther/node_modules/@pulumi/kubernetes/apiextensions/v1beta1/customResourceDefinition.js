...
exports.CustomResourceDefinition = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../../utilities");
/**
 * CustomResourceDefinition represents a resource that should be exposed on the API server.  Its name MUST be in the format <.spec.name>.<.spec.group>. Deprecated in v1.16, planned for removal in v1.19. Use apiextensions.k8s.io/v1 CustomResourceDefinition instead.
 */
class CustomResourceDefinition extends pulumi.CustomResource {
    /**
    ...
    constructor(name, args, opts) {
        ...
        super(CustomResourceDefinition.__pulumiType, name, resourceInputs, opts);
    }
    /**
    ...
    static get(name, id, opts) {
        return new CustomResourceDefinition(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
CustomResourceDefinition.__pulumiType = 'kubernetes:apiextensions.k8s.io/v1beta1:CustomResourceDefinition';
//# sourceMappingURL=customResourceDefinition.js.map