...
exports.PodSecurityPolicy = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../../utilities");
/**
 * PodSecurityPolicy governs the ability to make requests that affect the Security Context that will be applied to a pod and container. Deprecated: use PodSecurityPolicy from policy API Group instead.
 */
class PodSecurityPolicy extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new PodSecurityPolicy(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
PodSecurityPolicy.__pulumiType = 'kubernetes:extensions/v1beta1:PodSecurityPolicy';
//# sourceMappingURL=podSecurityPolicy.js.map