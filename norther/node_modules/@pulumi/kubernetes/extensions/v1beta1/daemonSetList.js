...
exports.DaemonSetList = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../../utilities");
/**
 * DaemonSetList is a collection of daemon sets.
 */
class DaemonSetList extends pulumi.CustomResource {
    /**
    ...
    constructor(name, args, opts) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "DaemonSetList";
        ...
        super(DaemonSetList.__pulumiType, name, resourceInputs, opts);
    }
    /**
    ...
    static get(name, id, opts) {
        return new DaemonSetList(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
DaemonSetList.__pulumiType = 'kubernetes:extensions/v1beta1:DaemonSetList';
//# sourceMappingURL=daemonSetList.js.map