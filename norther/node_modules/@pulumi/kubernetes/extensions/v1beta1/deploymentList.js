 ...
 */
class DeploymentList extends pulumi.CustomResource {
    /**
    ...
    constructor(name, args, opts) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "DeploymentList";
        ...
        super(DeploymentList.__pulumiType, name, resourceInputs, opts);
    }
    /**
    ...
    static get(name, id, opts) {
        return new DeploymentList(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
DeploymentList.__pulumiType = 'kubernetes:extensions/v1beta1:DeploymentList';
//# sourceMappingURL=deploymentList.js.map