...
exports.APIServiceList = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../../utilities");
/**
 * APIServiceList is a list of APIService objects.
 */
class APIServiceList extends pulumi.CustomResource {
    /**
    ...
    constructor(name, args, opts) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "APIServiceList";
    ...
    static get(name, id, opts) {
        return new APIServiceList(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
APIServiceList.__pulumiType = 'kubernetes:apiregistration.k8s.io/v1beta1:APIServiceList';
//# sourceMappingURL=apiserviceList.js.map