...
exports.PriorityClass = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../../utilities");
/**
 * DEPRECATED - This group version of PriorityClass is deprecated by scheduling.k8s.io/v1/PriorityClass. PriorityClass defines mapping from a priority class name to the priority integer value. The value can be any valid integer.
 */
class PriorityClass extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new PriorityClass(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
PriorityClass.__pulumiType = 'kubernetes:scheduling.k8s.io/v1alpha1:PriorityClass';
//# sourceMappingURL=priorityClass.js.map