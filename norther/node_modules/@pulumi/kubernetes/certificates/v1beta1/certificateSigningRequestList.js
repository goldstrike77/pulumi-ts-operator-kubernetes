...
exports.CertificateSigningRequestList = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../../utilities");
class CertificateSigningRequestList extends pulumi.CustomResource {
    /**
    ...
    constructor(name, args, opts) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "CertificateSigningRequestList";
    ...
    static get(name, id, opts) {
        return new CertificateSigningRequestList(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
CertificateSigningRequestList.__pulumiType = 'kubernetes:certificates.k8s.io/v1beta1:CertificateSigningRequestList';
//# sourceMappingURL=certificateSigningRequestList.js.map