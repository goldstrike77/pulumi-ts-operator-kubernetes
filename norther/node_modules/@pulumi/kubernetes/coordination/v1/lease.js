 ...
 */
class Lease extends pulumi.CustomResource {
    /**
    ...
    constructor(name, args, opts) {
        ...
        super(Lease.__pulumiType, name, resourceInputs, opts);
    }
    /**
    ...
    static get(name, id, opts) {
        return new Lease(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.Lease = Lease;
/** @internal */
Lease.__pulumiType = 'kubernetes:coordination.k8s.io/v1:Lease';
