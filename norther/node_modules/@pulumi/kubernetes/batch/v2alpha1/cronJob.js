...
class CronJob extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:batch/v1:CronJob" }, { type: "kubernetes:batch/v1beta1:CronJob" }] };
    ...
    static get(name, id, opts) {
        return new CronJob(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
CronJob.__pulumiType = 'kubernetes:batch/v2alpha1:CronJob';
