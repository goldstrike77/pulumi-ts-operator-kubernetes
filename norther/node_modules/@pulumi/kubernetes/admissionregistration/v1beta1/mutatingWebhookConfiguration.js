...
exports.MutatingWebhookConfiguration = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../../utilities");
/**
 * MutatingWebhookConfiguration describes the configuration of and admission webhook that accept or reject and may change the object. Deprecated in v1.16, planned for removal in v1.19. Use admissionregistration.k8s.io/v1 MutatingWebhookConfiguration instead.
 */
class MutatingWebhookConfiguration extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new MutatingWebhookConfiguration(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
MutatingWebhookConfiguration.__pulumiType = 'kubernetes:admissionregistration.k8s.io/v1beta1:MutatingWebhookConfiguration';
//# sourceMappingURL=mutatingWebhookConfiguration.js.map