...
exports.ValidatingWebhookConfiguration = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../../utilities");
/**
 * ValidatingWebhookConfiguration describes the configuration of and admission webhook that accept or reject and object without changing it. Deprecated in v1.16, planned for removal in v1.19. Use admissionregistration.k8s.io/v1 ValidatingWebhookConfiguration instead.
 */
class ValidatingWebhookConfiguration extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new ValidatingWebhookConfiguration(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
ValidatingWebhookConfiguration.__pulumiType = 'kubernetes:admissionregistration.k8s.io/v1beta1:ValidatingWebhookConfiguration';
//# sourceMappingURL=validatingWebhookConfiguration.js.map