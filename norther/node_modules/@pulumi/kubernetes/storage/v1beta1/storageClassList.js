...
exports.StorageClassList = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../../utilities");
/**
 * StorageClassList is a collection of storage classes.
 */
class StorageClassList extends pulumi.CustomResource {
    /**
    ...
    constructor(name, args, opts) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "StorageClassList";
        ...
        super(StorageClassList.__pulumiType, name, resourceInputs, opts);
    }
    /**
    ...
    static get(name, id, opts) {
        return new StorageClassList(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
StorageClassList.__pulumiType = 'kubernetes:storage.k8s.io/v1beta1:StorageClassList';
//# sourceMappingURL=storageClassList.js.map