...
exports.StatefulSetList = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../../utilities");
/**
 * StatefulSetList is a collection of StatefulSets.
 */
class StatefulSetList extends pulumi.CustomResource {
    /**
    ...
    constructor(name, args, opts) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "StatefulSetList";
        ...
        super(StatefulSetList.__pulumiType, name, resourceInputs, opts);
    }
    /**
    ...
    static get(name, id, opts) {
        return new StatefulSetList(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
StatefulSetList.__pulumiType = 'kubernetes:apps/v1beta1:StatefulSetList';
//# sourceMappingURL=statefulSetList.js.map