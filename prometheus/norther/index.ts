        ...
        secret: [
            {
                ...
                data: {
                    ...
                    "cache.yml": ""
                },
                stringData: {}
            }
        ],
            ...
            },
            {
                ...
                values: {
                    ...
                    compactor: {
                        ...
                        extraFlags: ["--compact.cleanup-interval=1h"],
                        resources: {
                    ...
                    storegateway: {
                        ...
                        extraFlags: [
                            ...
                            "--index-cache.config-file=/conf/cache.yml",
                            "--store.caching-bucket.config-file=/conf/cache.yml"
                        ],
                        replicaCount: 1,
                        resources: {
